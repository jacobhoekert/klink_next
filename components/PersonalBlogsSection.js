...
const PersonalBlogsSection = () => {
  return (
    <section id="personal-blogs-section">
      ...
      <div id="people">
        <a href="https://kelsonmudd.theglobalu.org" id="kelson" className="member" target="_blank" rel="noopener">
          <div className="hover-gradient"></div>
          <p className="name">Kelson Mudd</p>
        </a>
        <a href="https://nathanbird.theglobalu.org" id="nathan" className="member" target="_blank" rel="noopener">
          <div className="hover-gradient"></div>
          <p className="name">Nathan Bird</p>
        </a>
        <a href="https://troyermorse.theglobalu.org" id="troyer" className="member" target="_blank" rel="noopener">
          <div className="hover-gradient"></div>
          <p className="name">Troyer Morse</p>
        </a>
        <a href="https://jacobhoekert.theglobalu.org" id="jacob" className="member" target="_blank" rel="noopener">
          <div className="hover-gradient"></div>
